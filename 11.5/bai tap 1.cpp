...
int main(){
	...
	if(S1==arr1[0]){
		printf("Mang 1 co tong lon nhat = %d",arr1[0]);
		}
	if(S2==arr1[0]){
		printf("Mang 2 co tong lon nhat = %d",arr1[0]);
	}
	if(S3==arr1[0]){
		printf("Mang 3 co tong lon nhat = %d",arr1[0]);
	}
	if(S4==arr1[0]){
		printf("Mang 4 co tong lon nhat = %d",arr1[0]);
	}
	return 0;
}
